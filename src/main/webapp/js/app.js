...
*/
	...
	$.defaultPage = 'main.shtml';
	$.subPagesDirectory = '/';
	$.page404 = '/error/404.shtml';
	$.mainContent = $('#ui-view');
...
function loadPage(url) {
	$.mainContent.html('<iframe src="'+url+'" id="Iframe" frameborder="5" scrolling="no" style="border:0px;" width="100%" height="100%"></iframe>');
